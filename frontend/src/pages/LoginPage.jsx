...
const LoginPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-[#3EB489]'>Login to your account</h2>
			</motion.div>
			...
			>
				<div className='bg-gray-100 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
					<form onSubmit={handleSubmit} className='space-y-6'>
						<div>
							<label htmlFor='email' className='block text-sm font-medium text-[#2E8B57]'>
								Email address
							</label>
					...
					<p className='mt-8 text-center text-sm text-gray-700'>
						Not a member?{" "}
						<Link to='/signup' className='font-medium text-[#3EB489] hover:text-[#3EB489]'>
